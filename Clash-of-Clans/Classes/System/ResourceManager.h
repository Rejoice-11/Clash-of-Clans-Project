...
class ResourceManager 
{
    public:
        ...
        // 存储上限由外部系统（如储金罐等级）决定
        void setMaxGoldStorage(int max) 
        {
            _maxGoldStorage = max; 
        }

        void setMaxElixirStorage(int max)
        {
            _maxElixirStorage = max;
        }

        int getMaxGoldStorage() const 
        { 
            return _maxGoldStorage;
        }

        int getMaxElixirStorage() const 
        { 
            return _maxElixirStorage;
        }
        ...
        { 
            return _townHallLevel; 
        }

        void setTownHallLevel(int level) 
        {
            _townHallLevel = level; 
        }
